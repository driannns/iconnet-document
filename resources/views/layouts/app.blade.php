...
<head>
    ...
    <title>Surat Tugas-{{ Session::get('nosurat') }}-{{ Session::get('date') }}</title>
        ...
        <aside id="default-sidebar"
            ...
            <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800 relative">
                <ul class="space-y-2 font-medium">
                    ...
                    <li>
                        <a href="/pengajuan"
                            ...
                            <span class="flex-1 ml-3 whitespace-nowrap">Pembuatan Surat Tugas</span>
                        </a>
                    </li>
                    <li>
                ...
                <button id="btn-print" class="absolute bottom-0 w-11/12 mb-5 flex items-center bg-gray-50 p-2 mr-3 text-gray-900 rounded-lg
                    ...
                    <span class="ml-3">Generate PDF</span>
                </button>
            </div>
        </aside>
